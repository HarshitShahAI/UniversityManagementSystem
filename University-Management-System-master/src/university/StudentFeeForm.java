...
public class StudentFeeForm extends JFrame implements ActionListener{
	...
	c1.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        ...
        try{
            ...
            ResultSet rs = cn.createStatement().executeQuery("select * from student");
            while(rs.next()){
	...
	contentPane.add(t3);
        ...
        try{
			Connection cn=Conn.Connect();
            ResultSet rs = cn.createStatement().executeQuery("select * from student where rollno = '"+c1.getSelectedItem()+"'");
            while(rs.next()){
