    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == b1) {
            try {
                ...
                ps.setString(1, rollno);  // Set the rollno parameter
                ...
                if (rowsAffected > 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "No record found with the provided roll number.");
                }

                // Close the current window and open the StudentDetails window
