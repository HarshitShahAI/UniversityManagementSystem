   ...
   public void mark(String s){
    try{
        Connection cn=Conn.Connect();
           ...
           ResultSet rs1 = cn.createStatement().executeQuery("select * from subject where rollno="+s);
           ...
           ResultSet rs2 = cn.createStatement().executeQuery("select * from marks where rollno="+s);
